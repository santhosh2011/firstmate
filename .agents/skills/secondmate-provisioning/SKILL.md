...
Because both ends of a remote transfer derive that set from the same declaration, the boundary reaches a remote home on the same terms as a local one.
