...
Codex shows a directory-trust dialog on the first run for a repository root; `references/harness/codex.md` owns the detail and the spawn-time pre-registration for an SDev workspace.
