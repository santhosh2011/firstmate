...
#                       when locked.
#   4. retention summary - one plain latest-summary sentence when a scheduled
#                       retention run has published one.
#   5. supervision instructions - render the detected harness protocol.
